...
var RequestModelAttributeParamObject_1 = require("../request/types/RequestModelAttributeParamObject");
...
var RequestRouter = /** @class */ (function () {
    ...
    RequestRouter.setLogLevel = function (level) {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, parseRequestBody(requestHeaders)];
                    case 1:
                        _d = _e.sent();
                        return [3 /*break*/, 3];
                    case 2:
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, lodash_1.reduce(routes, function (previousPromise, route) { return __awaiter(_this, void 0, void 0, function () {
                                var routeController, routePropertyName, routePropertyParams, modelAttributeValues_1, routeAttributeNames_1, allModelAttributeNamesForRouteController, attributeNamePairs, stepParams, stepResult;
                                var _this = this;
                                var _a;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        ...
                                        case 1:
                                            _b.sent();
                                            if (!(this._modelAttributeNames && this._modelAttributeNames.has(routeController))) return [3 /*break*/, 3];
                                            LOG.debug("Populating attributes for property \"" + routePropertyName + "\"");
                                            modelAttributeValues_1 = RequestRouter._getOrCreateRequestModelAttributesForController(requestModelAttributes_1, routeController);
                                            routeAttributeNames_1 = lodash_1.map(lodash_1.filter(routePropertyParams, function (item) { return RequestModelAttributeParamObject_1.isRequestModelAttributeParamObject(item); }), function (item) { return item.attributeName; });
                                            LOG.debug('route attributeNames: ', routeAttributeNames_1);
                                            allModelAttributeNamesForRouteController = this._modelAttributeNames.get(routeController);
                                            LOG.debug('all attributeNamePairs: ', allModelAttributeNamesForRouteController);
                                            attributeNamePairs = lodash_1.filter(allModelAttributeNamesForRouteController !== null && allModelAttributeNamesForRouteController !== void 0 ? allModelAttributeNamesForRouteController : [], function (item) { return routeAttributeNames_1.includes(item[0]); });
                                        ...
                                        case 2:
                                            ...
                                            _b.label = 3;
                                        case 3:
                                            stepParams = RequestRouter._bindRequestActionParams(requestQueryParams_1, requestBody_1, routePropertyParams, requestHeaders, pathVariables_1, (_a = requestModelAttributes_1.get(routeController)) !== null && _a !== void 0 ? _a : new Map());
                                            // LOG.debug('handleRequest: stepParams 1: ', stepParams);
                                            // LOG.debug('handleRequest: stepParams 2: ', stepParams);
                                            if (!lodash_1.has(routeController, routePropertyName)) {
                                                LOG.warn("Warning! No property by name \"" + routePropertyName + "\" found in the controller");
                                                responseEntity_1 = ResponseEntity_1.default.notFound().body({ error: "404 - Not Found", code: 404 });
                                                return [2 /*return*/];
                                            }
    ...
    RequestRouter._getOrCreateRequestModelAttributesForController = function (requestModelAttributes, routeController) {
        var modelAttributeValues = requestModelAttributes.get(routeController);
