...
exports.isResponseEntityOf = exports.isResponseEntity = exports.ResponseEntity = exports.isEntityStatusType = void 0;
...
function isResponseEntityOf(value, isTest) {
    return !!value && value instanceof ResponseEntity && isTest(value.getBody());
}
exports.isResponseEntityOf = isResponseEntityOf;
