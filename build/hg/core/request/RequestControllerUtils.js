...
var RequestControllerUtils = /** @class */ (function () {
    ...
    RequestControllerUtils.setLogLevel = function (level) {
    ...
    RequestControllerUtils.setControllerMethodPathVariable = function (controller, propertyKey, paramIndex, variableName, paramType, isRequired, decodeValue, defaultValue) {
        var newParam = {
            ...
            decodeValue: decodeValue !== null && decodeValue !== void 0 ? decodeValue : true,
            defaultValue: defaultValue
        };
        RequestControllerUtils._setControllerMethodParam(controller, propertyKey, paramIndex, newParam);
    };
