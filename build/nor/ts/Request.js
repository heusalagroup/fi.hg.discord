...
exports.RequestError = exports.Headers = exports.ResponseEntity = exports.RequestBody = exports.DeleteMapping = exports.PutMapping = exports.PostMapping = exports.GetMapping = exports.OptionsMapping = exports.ModelAttribute = exports.PathVariable = exports.RequestHeader = exports.RequestParam = exports.RequestMapping = exports.Request = void 0;
...
exports.ResponseEntity = ResponseEntity_1.default;
...
var Request = /** @class */ (function () {
    ...
    Request.param = function (arg1, arg2, arg3) {
        if (lodash_1.isString(arg1) && arg3 === undefined && (arg2 === undefined || RequestParamValueType_1.isRequestParamValueType(arg2))) {
    ...
    Request.header = function (arg1, arg2, arg3) {
        ...
        if (lodash_1.isString(arg1)) {
            ...
            if (!(arg2 === undefined || RequestHeaderOptions_1.isRequestHeaderOptions(arg2))) {
    ...
    Request.pathVariable = function (arg1, arg2, arg3) {
        ...
        if (lodash_1.isString(variableName)) {
            if (!(arg2 === undefined || RequestPathVariableOptions_1.isRequestPathVariableOptions(arg2))) {
            ...
            return function (target, propertyKey, paramIndex) {
                if (lodash_1.isString(propertyKey) && lodash_1.isNumber(paramIndex)) {
                    var requestController = RequestControllerUtils_1.default.findController(target);
                    if (requestController !== undefined) {
                        RequestControllerUtils_1.default.setControllerMethodPathVariable(requestController, propertyKey, paramIndex, variableName, RequestParamValueType_1.default.STRING, isRequired_2, defaultValue_2);
                        return;
                    }
                }
        ...
        var defaultValues = opts ? (_c = opts === null || opts === void 0 ? void 0 : opts.defaultValues) !== null && _c !== void 0 ? _c : undefined : undefined;
        return function (target, propertyKey, paramIndex) {
            if (lodash_1.isString(propertyKey) && lodash_1.isNumber(paramIndex)) {
