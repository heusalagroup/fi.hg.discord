...
var NodeRequestClient = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, this._findSocketFile(parentPath)];
                }
            });
        });
    };
    ...
    NodeRequestClient.prototype._request = function (url, options, body) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._httpRequest(url, options, body)];
                    case 1:
                        response = _b.sent();
    ...
    NodeRequestClient.prototype._getJson = function (url, headers, data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this._request(url, options, data).then(NodeRequestClient._successResponse)];
            });
        });
    };
